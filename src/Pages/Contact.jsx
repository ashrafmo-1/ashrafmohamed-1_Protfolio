...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          Swal.fire("done", "your mail is sent", "success");
        },
        (error) => {
          Swal.fire(
  ...
  return (
    <div style={{ minHeight: "calc(100vh - 83px)" }}>
        ...
        <div className="containerFromCOmp">
          <div className={"all-content"}>
            <form ref={form} onSubmit={sendEmail}>
              ...
              <button type="submit" className="btnSent">
                send
              </button>
            </form>
            <div className={"talk"}>
              ...
              <div className="contacts">
                ...
                <a
                  className={"social"}
                  href={"mailto:ashrafmohamed1176@gmail.com"}
                >
                ...
                <a
                  className={"social"}
                  href={"https://www.linkedin.com/in/ashraf-mohamed-b931a7236"}
                >
